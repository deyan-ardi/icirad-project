                    ...
                    <div class="col-md-12">
                        <div class="event-schedule">
                                ...
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-terms-tab" data-toggle="tab" href="#nav-terms" role="tab" aria-controls="nav-terms" aria-selected="true">
                                        <div class="es-day">
                                            ...
                                            <div class="es-day-details2">
                                                <span>International Advisory Board</span><br>
                                                <span>List of International Advisory Board</span>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="nav-item nav-link" id="nav-privacy-tab" data-toggle="tab" href="#nav-privacy" role="tab" aria-controls="nav-privacy" aria-selected="false">
                                        <div class="es-day">
                                            ...
                                            <div class="es-day-details2">
                                                <span>Steering Committee</span><br>
                                                <span>List of Steering Committee</span>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="nav-item nav-link" id="nav-scientific-tab" data-toggle="tab" href="#nav-scientific" role="tab" aria-controls="nav-scientific" aria-selected="true">
                                        <div class="es-day">
                                            ...
                                            <div class="es-day-details2">
                                                <span>Scientific Commitee </span><br>
                                                <span>List of Scientific Commitee</span>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="nav-item nav-link" id="nav-organizing-tab" data-toggle="tab" href="#nav-organizing" role="tab" aria-controls="nav-organizing" aria-selected="true">
                                        <div class="es-day">
                                            <div class="es-day-details">
                                                <span><i class="fa fa-users"></i></span>
                                            </div>
                                            <div class="es-day-details2">
                                                ...
                                                <span>List of Organizing Committee </span>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-terms" role="tabpanel" aria-labelledby="nav-terms-tab">
                                    <div class="event-details">
                                        <div class="ed-content">
                                            <h5>List Of International Advisory Board</h5>
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <p><i class="fa fa-check"></i> Prof. Susan Palmisano (Indiana University of Pennsylvania - USA)</p>
                                                </li>
                                                <li>
                                                    <p><i class="fa fa-check"></i> Prof. Melani Budianta, Ph.D. (Universitas Indonesia - Indonesia)</p>
                                                </li>
                                                <li>
                                                    <p><i class="fa fa-check"></i> Prof. Zainal A.Hasibuan, Ir.,MLS, PhD. (Universitas Indonesia - Indonesia)</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="nav-scientific" role="tabpanel" aria-labelledby="nav-scientific-tab">
                                    <div class="event-details">
                                        <div class="ed-content">
                                ...
                                <div class="tab-pane fade" id="nav-organizing" role="tabpanel" aria-labelledby="nav-organizing-tab">
                                    <div class="event-details">
                                        <div class="ed-content">
                                            <h5>List Of Organizing Committee</h5>
                                            <ul>
                                                <br>
                                                <li>
                                                    <em> Chairman of The Committee (Conference Chair)</em>
                                                </li>
                                                <br>
                                                <li>
        ...
        <section class="location">
            <div class="map-2">
                <div class="" id="googleMap2">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3949.852220352381!2d115.08554221484891!3d-8.116525383468185!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd24116b203f1bd%3A0x75078d34d4179074!2sGanesha%20University%20of%20Education!5e0!3m2!1sen!2sid!4v1629374097576!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
        </section>